...
| :----------------------- | :--------------------------------------------------------------------------------------- | :--------------: | :-----------------------: | :------------------------: | :----------------------: |
| **Modelado de negocio**  | [Modelo de dominio](../01-business-modeling/domain-model.md)                             |        s         |             r             |                            |                          |
| **Requisitos**           | [Documento de visión](../02-requirements/vision.md)                                      |        s         |             r             |                            |                          |
|                          | [Modelo de casos de uso](../02-requirements/use-cases/brief-use-cases.md)                |        s         |             r             |             r              |                          |
|                          | [Especificación suplementaria](../02-requirements/supp-spec.md)                          |        s         |             r             |                            |                          |
|                          | [Glosario y diccionario de datos](../02-requirements/glossary.md)                        |        s         |             r             |                            |                          |
| **Diseño**               | [Modelo de diseño (DCD, Secuencia)](../03-design/design-class-diagrams/domain-engine.md) |                  |             s             |             r              |                          |
|                          | [Documento de arquitectura de software (SAD)](../03-design/sad.md)                       |                  |             s             |             r              |                          |
...
- **[Modelo de dominio](../01-business-modeling/domain-model.md):** Captura
  visualmente las clases conceptuales del problema (estructogramas, bloques,
  variables, memoria, ámbitos). Se inicia en Inicio y se consolida en
  Elaboración; no se mantiene como modelo formal en Construcción para evitar
  duplicación con el código fuente.

### 4.2 Requisitos

- **[Documento de visión](../02-requirements/vision.md):** Resumen ejecutivo que
  establece el caso de negocio, la lista de actores/objetivos, las _System
  Features_ y las restricciones del producto.
- **[Modelo de casos de uso](../02-requirements/use-cases/brief-use-cases.md):**
  ...
  - _Formato detallado:_ Reservado exclusivamente para el subconjunto crítico
    (~10%) que gobierna el núcleo de la arquitectura: _[UC02 (Ejecutar y depurar
    algoritmo)](../02-requirements/use-cases/uc02.md)_ y _[UC06 (Resolver tarea
    evaluable)](../02-requirements/use-cases/brief-use-cases.md#uc06-resolver-tarea-evaluable)_.
  - _Diagramas de secuencia del sistema
    ([DSS](../02-requirements/ssd/uc02.md)):_ Se construyen para los casos de
    uso críticos con el fin de identificar formalmente las operaciones del
    sistema como caja negra.
- **[Especificación suplementaria](../02-requirements/supp-spec.md):**
  Centraliza todos los requisitos no funcionales (FURPS+), restricciones
  tecnológicas y reglas de negocio formales (semántica N-S, tipado, memoria
  dinámica, criptografía).
- **[Glosario](../02-requirements/glossary.md):** Define el vocabulario común y
  opera como diccionario de datos para los tipos de datos, estructuras de
  memoria y formatos de archivo.

### 4.3 Diseño

- **[Modelo de diseño](../03-design/design-class-diagrams/domain-engine.md):**
  Comprende los [diagramas de
  interacción](../03-design/interaction-diagrams/uc02.md) y [diagramas de clases
  de diseño (DCD)](../03-design/design-class-diagrams/domain-engine.md)
  enfocados en resolver los puntos complejos del motor lógico (patrón
  _Interpreter_, gestión de ámbitos, cálculo geométrico).
- **[Documento de arquitectura de software (SAD)](../03-design/sad.md):**
  Consolida las decisiones técnicas (_Technical Memos_) y las vistas
  arquitectónicas relevantes del modelo N+1 (Lógica, Despliegue y Procesos). No
  se crea de forma especulativa en papel, sino que documenta la arquitectura
  ejecutable base estabilizada durante Elaboración.
...
1. **Desarrollo dirigido por el riesgo (_Risk-Driven_):** El esfuerzo de las
   ...
   ejecutable del intérprete y el cálculo geométrico N-S (mitigación de
   [R1](../08-project-management/risk-list.md#2-matriz-de-evaluación-y-mitigación-de-riesgos)
   y
   [R2](../08-project-management/risk-list.md#2-matriz-de-evaluación-y-mitigación-de-riesgos)).
